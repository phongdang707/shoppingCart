...
*
*/
var loadIcon = "//cdn.shopify.com/s/files/1/1200/5998/t/2/assets/loading.gif?14909988788694964106";
...
function linkOptionSelectorsQuickview(t) {
    for (var n = 0; n < t.variants.length; n++) {var r = t.variants[n];if (r.available) {Shopify.optionsMapQuickview["root"] = Shopify.optionsMapQuickview["root"] || [];Shopify.optionsMapQuickview["root"].push(r.option1);Shopify.optionsMapQuickview["root"] = Shopify.uniq(Shopify.optionsMapQuickview["root"]);if (t.options.length > 1) {var i = r.option1;Shopify.optionsMapQuickview[i] = Shopify.optionsMapQuickview[i] || [];Shopify.optionsMapQuickview[i].push(r.option2);Shopify.optionsMapQuickview[i] = Shopify.uniq(Shopify.optionsMapQuickview[i])}if (t.options.length === 3) {var i = r.option1 + " / " + r.option2;Shopify.optionsMapQuickview[i] = Shopify.optionsMapQuickview[i] || [];Shopify.optionsMapQuickview[i].push(r.option3);Shopify.optionsMapQuickview[i] = Shopify.uniq(Shopify.optionsMapQuickview[i])}}}
		...
		$(document).on('click', '.quick-view', function(e){
			...
			Shopify.getProduct(producthandle,function(product) {
                ...
                if(product.available){
                  	...
                  	quickview.find(".product-info .availability").append("<p class=\"available outstock\">Out stock</p>");
                }
...
(function($) {
	...
	$(document).ready(function() {
  	...
  	var apollo = {
        ...
        $('#pagination').remove();
        if ($(".content_sortPagiBar", data.responseText).length && $(".content_sortPagiBar", data.responseText).html() != '') {
            $('.content_sortPagiBar').html($(".content_sortPagiBar", data.responseText).html());
          	var responsive = data.responseText;
          	console.log($(responsive).find('.product-block').length);
        }
